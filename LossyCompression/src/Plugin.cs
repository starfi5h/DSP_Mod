...
namespace LossyCompression
{
    ...
    public class Plugin : BaseUnityPlugin, IModCanSave
    {
        ...
        public void Awake()
        {
            ...
            var MultiThread = Config.Bind<bool>("Advance", "MultiThreading", true, "Enable multi-threading to speed up loading (use more RAM)\n启用多线程加快载入速度(使用更多内存)");
            ...
            DysonShellCompress.IsMultithread = MultiThread.Value;
            DysonSwarmCompress.IsMultithread = MultiThread.Value;
            ...
            UIcontrol.Init();
            // TODO: Refresh DSPModSave dictionary for script engine
            //var dict = (Dictionary<string, ModSaveSettings>)AccessTools.Field(typeof(DSPModSavePlugin), "allModData").GetValue(null);
            //dict[GUID] = Instance;
#endif
        }
